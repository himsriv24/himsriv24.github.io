...
excerpt: "A self-supervised CNN-Transformer framework for automated ictal onset zone classification from SEEG spectrograms, with multi-center validation.<br/><img src='/images/projects/deep_learning_soz.png' style='max-width:400px;'>"
